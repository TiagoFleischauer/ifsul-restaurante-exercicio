...
public class RestauranteController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Atualiza o restaurante com o ID fornecido",
                    content = { @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = Restaurante.class))) })
    })
    @PutMapping("/{id}")
    ...
    @Operation(summary = "Busca restaurantes por nome")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Retorna uma lista de restaurantes com o nome fornecido",
                    content = { @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = Restaurante.class))) })
    })
    ...
    @Operation(summary = "Busca restaurantes por endereço")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Retorna uma lista de restaurantes com o endereço fornecido",
                    content = { @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = Restaurante.class))) })
    })
    ...
    @Operation(summary = "Busca restaurantes por cozinha")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Retorna uma lista de restaurantes com o tipo de cozinha fornecido",
                    content = { @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = Restaurante.class))) })
    })
